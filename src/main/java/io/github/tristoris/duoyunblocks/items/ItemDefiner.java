...
public final class ItemDefiner {
    public static final Item DUOYUN_BLOCK_ITEM_BAD_LUCK =
            register("duoyun_block_item_negative", settings -> new DuoyunBlockItem(BlockDefiner.DUOYUN_BLOCK, settings, -100), new Item.Settings());

    public static final Item DUOYUN_BLOCK_ITEM =
            register("duoyun_block_item", settings -> new DuoyunBlockItem(BlockDefiner.DUOYUN_BLOCK, settings, 0), new Item.Settings());

    public static final Item DUOYUN_BLOCK_ITEM_GOOD_LUCK =
            register("duoyun_block_item_positive", settings -> new DuoyunBlockItem(BlockDefiner.DUOYUN_BLOCK, settings, 100), new Item.Settings());
